package pooherenciaejex02;

import java.util.ArrayList;
import pooherenciaejex02.entidades.Edificio;
import pooherenciaejex02.servicios.ServiciosEdificio;
 ...
 * calcularVolumen en cada Edificio. 
 ...
 * polideportivos son techados y cuantos abiertos. 
 * Y para la clase EdificioDeOficinas deberemos llamar al método cantPersonas() 
 * y mostrar los resultados de cada edificio de oficinas.
 *
 * @author epellejero
 */
public class POOHerenciaEjEx02 {

    public static void main(String[] args) {
        
        ServiciosEdificio s1 = new ServiciosEdificio();
        ArrayList<Edificio> listaEdificio = new ArrayList<>();
        
        s1.altaPolideportivo();
        s1.altaEdificioDeOficinas();
