package pooherenciaejex02.servicios;
...
public class ServiciosEdificio {
    ...
    public void altaPolideportivo(){
        System.out.println("------------- Alta Polideportivo -------------");     
        
        System.out.println(" ");
    }
    
    public void altaEdificioDeOficinas(){
        System.out.println("------------ Alta edificio oficinas ----------");     
