package pooherenciaej03;

import pooherenciaej03.servicios.Servicios;
...
public class POOHerenciaEj03 {

    public static void main(String[] args) {
        
        Servicios servicios = new Servicios();
        
        servicios.crearLavadora();
        servicios.precioFinalLavadora();
                        
        servicios.crearTelvisor();
        servicios.precioFinalTelevisor();
        
        servicios.crearHeladera();
        servicios.precioFinalHeladera();
        
        servicios.mostrarElectrodomesticos();
    }
