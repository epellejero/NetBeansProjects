...
public class POOEjEx02 {
    ...
    public static void main(String[] args) {
        ...
        Persona p1 = ps1.altaPersona();
        Persona p2 = ps1.altaPersona();
        Persona p3 = ps1.altaPersona();
        ...
        for (int i = 0; 1 < 3; i++){
            ...
            // calculo ICM 
            switch (ps1.calcularIMC(vectorPersonas[i])){
                case 0:
            ...
            if (ps1.esMayorDeEdad(vectorPersonas[i])){
