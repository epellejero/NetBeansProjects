package pooherenciaej02.servicios;

import java.util.ArrayList;
import java.util.List;
import java.util.Scanner;
import pooherenciaej02.entidades.Electrodomesticos;
import pooherenciaej02.entidades.Heladera;
...
public class Servicios {
    ...
    double precio,plusConsumo,plusPeso,plusCarga,plusResolucion,plusSintonizador,precioFinal;
    String color;
    char consumo;
    int peso,carga,resolucion;
    ...
    public void precioFinalLavadora(){
        ...
        precioFinal = precioFinal + precio + plusCarga;
    ...
    public void precioFinalTelevisor(){
        precioFinal = precioFinal();
        if (resolucion > 40){
            plusResolucion = precio*0.30;
        }
        if (sintonizadorTDT){
            plusSintonizador = 500;
        }
        precioFinal = precioFinal + precio + plusResolucion + plusSintonizador;
...
//                System.out.println("Televisor " + televisor);
                continue;
            }
