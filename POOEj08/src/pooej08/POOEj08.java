...
import pooej08.entidades.Cadena;
...
public class POOEj08 {
    ...
    public static void main(String[] args) {
        ...
        fraseUsuario.setFrase(frase);
        fraseUsuario.setLongitudDeFrase(longitud);
        
        System.out.println(" FRASE " + fraseUsuario.getFrase());
        System.out.println(" Longitud " + fraseUsuario.getLongitudDeFrase());
        
        System.out.println("Vocales : " + fraseUsuario.mostrarVocales());
        
        fraseUsuario.invertirFrase();
        
        System.out.print("Ingrese una letra a buscar en frase : ");
        String caracter = leer.next();
        System.out.println("Veces repetido : " + fraseUsuario.vecesRepetido(caracter));
        
        System.out.print("Ingrese una nueva frase : ");
        frase = leer.next();
        longitud = frase.length();
        fraseUsuario.compararLongitud(longitud);
        
        fraseUsuario.unirFrases(frase);
           
        System.out.print("Ingrese un caracter para reemplazar : ");
        caracter = leer.next();
        fraseUsuario.reemplazarFrase(caracter);
        
        System.out.print("Ingrese una letra a buscar en frase : ");
        caracter = leer.next();
        if (fraseUsuario.contieneLetra(caracter)){
            System.out.println("Contiene el caracter ingresado");
        } else {
            System.out.println("NO Contiene el caracter ingresado");
        }
