...
import pooextraej03.entidades.Raices;
 ...
 *   las 2 ́ posibles soluciones. 
 *  Método obtenerRaiz(): llama a tieneRaiz() y si devolvió true imprime una 
 *   única raíz. ́ Es en el caso en que se tenga una única solución posible. 
...
public class POOEXTRAEj03 {
    ...
    public static void main(String[] args) {
        ...
        r1.setCoeficienteA(a);
        System.out.print("Ingrese el valor del coeficiente B : ");
        double b = leer.nextDouble();
        r1.setCoeficienteB(b);
        System.out.print("Ingrese el valor del coeficiente C : ");
        double c = leer.nextDouble();
        r1.setCoeficienteC(c);
        
        if (Double.isNaN(r1.calcular(a,b,c))){
            System.out.println("No tiene solución");
        }else  if (r1.tieneRaiz()){
            r1.obtenerRaiz();
        } else if (r1.tieneRaices()){
            r1.obtenerRaices();
        }    
    }
}